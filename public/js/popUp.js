...
function popUp(name,widthmove,heightmove) {
  ...
  var myWindow;
    ...
    myWindow = window.open("https://lit-castle-51205.herokuapp.com/third", name, "width=" + widthThing + ", " + "height=" + heightThing + "," + "left=" + widthmove+ "," +  "top=" + heightmove);
    // myWindow.document.body.style.backgroundImage = bgURLS[bgRandom];

// $('document.body').css('background-color', 'url(' + imageUrl + ')');
    ...
    // myWindow.document.body.setAttribute('style', "background-color:red;");
    // myWindow.document.body.style.backgroundImage= "url('http://www.w3schools.com/css/img_fjords.jpg')"
